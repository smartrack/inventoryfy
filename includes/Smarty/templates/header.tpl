    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!-- /.dropdown -->
                <li class="dropdown {literal}{{dropdownUser?'open':''}}{/literal}">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)" ng-click="dropdownUser = !dropdownUser;">
